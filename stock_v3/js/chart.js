...
colors: {
    ...
    sma250:  '#7c3aed',
    ratio:   '#7c3aed',
    curPriceLine: 'rgba(15,23,42,0.30)',
    volUp:   'rgba(34,197,94,0.25)',
    volDown: 'rgba(239,68,68,0.25)',
    indZero: 'rgba(15,23,42,0.18)',
    crosshair:    'rgba(15,23,42,0.25)',
    tooltipBg:    'rgba(15,23,42,0.90)',
    tooltipText:  '#f1f5f9',
    zoomOverlay:  'rgba(14,165,233,0.10)',
    zoomEdge:     'rgba(14,165,233,0.55)',
    ratioBaseline:'rgba(15,23,42,0.18)',
    ratioFill:    'rgba(14,165,233,0.06)',
    ratioLine:    'rgba(14,165,233,0.85)',
  },
};
